...
def test_t_v1101_rpt_01_lint_docs_repointed_to_this_release():
    """Superseded by spec-v1.9.0 REQ-V190-RPT-01, v1.10.1 T2
    (REQ-V1101-RPT-01): lint-docs' report_path tracks the current release
    and is repointed again at each one -- this test's own name and assertion
    move with it (v1.10.1 T2: the v1.10.0-named predecessor asserted the
    v1.10.0 path, which T2's own required repoint made stale the same way
    v1.10.0 T6 made the v1.9.5-named one stale)."""
    ...
    assert lint_docs["report_path"] == "docs/reports/report-v1.10.1.md"
