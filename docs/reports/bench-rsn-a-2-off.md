...
|---|---|
| tag | rsn-a-2-off |
| started_at | 2026-09-03T12:18:04Z |
| finished_at | 2026-09-03T12:20:42Z |
...
| pricing.fetched_at | 2026-09-03T12:18:04Z |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| S05 | baseline | 1/1 | 6099 | 565 | 0 | 463 | 917 | 5182 | 1 | 1792 | 153841 | 154606 | 0.004033 | 2 | 0 |
...
| wall_ms | 154606 |
| success_rate | 1 |
| cost_per_success | 0.004033 |
| tokens_per_success | 6664.0 |
| resent_share | 0.150353 |
| cache_hit_rate | n/a |
| avg_per_task.tokens | 6664.0 |
| avg_per_task.rounds | 2 |
| avg_per_task.tool_calls | 1 |
| avg_per_task.latency_ms | 153841.0 |
...
- reasoning observed: yes, max reasoning_tokens: 447, max reasoning_chars: 1585, Σ reasoning_tokens: 463, reasoning share: 0.8195
- tool-exposed calls: calls: 2, reasoning observed: yes, max reasoning_tokens: 447, max reasoning_chars: 1585, Σ reasoning_tokens: 463, reasoning share: 0.8195
...
| scope | baseline |
|---|---|
| median latency_ms per call | 76920.5 |
| median latency_ms (agent) | 76920.5 |
