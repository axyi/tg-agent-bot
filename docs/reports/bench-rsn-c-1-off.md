...
|---|---|
| tag | rsn-c-1-off |
| started_at | 2026-09-03T12:24:23Z |
| finished_at | 2026-09-03T12:24:51Z |
...
| pricing.fetched_at | 2026-09-03T12:24:23Z |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| S05 | baseline | 1/1 | 2177 | 94 | 0 | 0 | 921 | 1256 | 1 | 150 | 24573 | 25334 | 0.001165 | 2 | 0 |
...
| wall_ms | 25334 |
| success_rate | 1 |
| cost_per_success | 0.001165 |
| tokens_per_success | 2271.0 |
| resent_share | 0.423059 |
| cache_hit_rate | n/a |
| avg_per_task.tokens | 2271.0 |
| avg_per_task.rounds | 2 |
| avg_per_task.tool_calls | 1 |
| avg_per_task.latency_ms | 24573.0 |
| prefix_share | 0.777216 |
...
- reasoning observed: no, max reasoning_tokens: 0, max reasoning_chars: 0, Σ reasoning_tokens: 0, reasoning share: 0.0000
- tool-exposed calls: calls: 2, reasoning observed: no, max reasoning_tokens: 0, max reasoning_chars: 0, Σ reasoning_tokens: 0, reasoning share: 0.0000
...
| scope | baseline |
|---|---|
| median latency_ms per call | 12286.5 |
| median latency_ms (agent) | 12286.5 |
