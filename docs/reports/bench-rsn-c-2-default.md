# Benchmark report — rsn-c-2-default
...
|---|---|
| tag | rsn-c-2-default |
| started_at | 2026-09-03T12:25:13Z |
| finished_at | 2026-09-03T12:27:42Z |
...
| pricing.fetched_at | 2026-09-03T12:25:13Z |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| S05 | baseline | 1/1 | 6099 | 448 | 0 | 349 | 917 | 5182 | 1 | 1792 | 144874 | 145621 | 0.003734 | 2 | 0 |
...
| wall_ms | 145621 |
| success_rate | 1 |
| cost_per_success | 0.003734 |
| tokens_per_success | 6547.0 |
| resent_share | 0.150353 |
| cache_hit_rate | n/a |
| avg_per_task.tokens | 6547.0 |
| avg_per_task.rounds | 2 |
| avg_per_task.tool_calls | 1 |
| avg_per_task.latency_ms | 144874.0 |
...
- reasoning observed: yes, max reasoning_tokens: 333, max reasoning_chars: 1132, Σ reasoning_tokens: 349, reasoning share: 0.7790
- tool-exposed calls: calls: 2, reasoning observed: yes, max reasoning_tokens: 333, max reasoning_chars: 1132, Σ reasoning_tokens: 349, reasoning share: 0.7790
...
| scope | baseline |
|---|---|
| median latency_ms per call | 72437.0 |
| median latency_ms (agent) | 72437.0 |
