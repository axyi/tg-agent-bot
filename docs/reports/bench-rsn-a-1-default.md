# Benchmark report — rsn-a-1-default
...
|---|---|
| tag | rsn-a-1-default |
| started_at | 2026-09-03T12:10:29Z |
| finished_at | 2026-09-03T12:12:57Z |
...
| pricing.fetched_at | 2026-09-03T12:10:29Z |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| S05 | baseline | 1/1 | 6099 | 444 | 0 | 345 | 917 | 5182 | 1 | 1792 | 143978 | 144811 | 0.003724 | 2 | 0 |
...
| wall_ms | 144811 |
| success_rate | 1 |
| cost_per_success | 0.003724 |
| tokens_per_success | 6543.0 |
| resent_share | 0.150353 |
| cache_hit_rate | n/a |
| avg_per_task.tokens | 6543.0 |
| avg_per_task.rounds | 2 |
| avg_per_task.tool_calls | 1 |
| avg_per_task.latency_ms | 143978.0 |
...
- reasoning observed: yes, max reasoning_tokens: 329, max reasoning_chars: 1102, Σ reasoning_tokens: 345, reasoning share: 0.7770
- tool-exposed calls: calls: 2, reasoning observed: yes, max reasoning_tokens: 329, max reasoning_chars: 1102, Σ reasoning_tokens: 345, reasoning share: 0.7770
...
| scope | baseline |
|---|---|
| median latency_ms per call | 71989.0 |
| median latency_ms (agent) | 71989.0 |
