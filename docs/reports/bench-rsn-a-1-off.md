...
|---|---|
| tag | rsn-a-1-off |
| started_at | 2026-09-03T12:12:57Z |
| finished_at | 2026-09-03T12:15:24Z |
...
| pricing.fetched_at | 2026-09-03T12:12:57Z |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| S05 | baseline | 1/1 | 6099 | 447 | 0 | 345 | 917 | 5182 | 1 | 1792 | 143846 | 144533 | 0.003732 | 2 | 0 |
...
| avg_per_task.latency_ms | 143846.0 |
...
- reasoning observed: yes, max reasoning_tokens: 329, max reasoning_chars: 1103, Σ reasoning_tokens: 345, reasoning share: 0.7718
- tool-exposed calls: calls: 2, reasoning observed: yes, max reasoning_tokens: 329, max reasoning_chars: 1103, Σ reasoning_tokens: 345, reasoning share: 0.7718
...
| scope | baseline |
|---|---|
| median latency_ms per call | 71923.0 |
| median latency_ms (agent) | 71923.0 |
