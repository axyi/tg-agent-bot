# Benchmark report — rsn-c-1-default
...
|---|---|
| tag | rsn-c-1-default |
| started_at | 2026-09-03T12:21:56Z |
| finished_at | 2026-09-03T12:24:23Z |
...
| pricing.fetched_at | 2026-09-03T12:21:56Z |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| S05 | baseline | 1/1 | 6099 | 447 | 0 | 345 | 917 | 5182 | 1 | 1792 | 143108 | 143850 | 0.003732 | 2 | 0 |
...
| wall_ms | 143850 |
| success_rate | 1 |
| cost_per_success | 0.003732 |
| tokens_per_success | 6546.0 |
| resent_share | 0.150353 |
| cache_hit_rate | n/a |
| avg_per_task.tokens | 6546.0 |
| avg_per_task.rounds | 2 |
| avg_per_task.tool_calls | 1 |
| avg_per_task.latency_ms | 143108.0 |
| prefix_share | 0.276111 |
...
|---|---|---|
| agent | calls | 2 |
| agent | prompt_tokens | 6099 |
| agent | completion_tokens | 447 |
| summary | calls | 0 |
...
| most expensive turn/round | S05-1 turn 3 round 2: 5182 prompt tokens |
| fastest-growing context category | tool (+6516.0 chars/run) |
| re-sent share | 0.150353 |

## Reasoning

### baseline

- reasoning observed: yes, max reasoning_tokens: 329, max reasoning_chars: 1102, Σ reasoning_tokens: 345, reasoning share: 0.7718
- tool-exposed calls: calls: 2, reasoning observed: yes, max reasoning_tokens: 329, max reasoning_chars: 1102, Σ reasoning_tokens: 345, reasoning share: 0.7718
...
| scope | baseline |
|---|---|
| median latency_ms per call | 71554.0 |
| median latency_ms (agent) | 71554.0 |
