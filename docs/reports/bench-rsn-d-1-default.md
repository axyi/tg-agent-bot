# Benchmark report — rsn-d-1-default
...
|---|---|
| tag | rsn-d-1-default |
| started_at | 2026-09-03T12:32:06Z |
| finished_at | 2026-09-03T12:34:33Z |
...
| pricing.fetched_at | 2026-09-03T12:32:06Z |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| S05 | baseline | 1/1 | 6099 | 447 | 0 | 345 | 917 | 5182 | 1 | 1792 | 142948 | 143676 | 0.003732 | 2 | 0 |
...
| avg_per_task.latency_ms | 142948.0 |
...
- reasoning observed: yes, max reasoning_tokens: 329, max reasoning_chars: 1100, Σ reasoning_tokens: 345, reasoning share: 0.7718
- tool-exposed calls: calls: 2, reasoning observed: yes, max reasoning_tokens: 329, max reasoning_chars: 1100, Σ reasoning_tokens: 345, reasoning share: 0.7718
...
| scope | baseline |
|---|---|
| median latency_ms per call | 71474.0 |
| median latency_ms (agent) | 71474.0 |
