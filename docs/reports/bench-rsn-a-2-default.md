# Benchmark report — rsn-a-2-default
...
|---|---|
| tag | rsn-a-2-default |
| started_at | 2026-09-03T12:15:41Z |
| finished_at | 2026-09-03T12:18:04Z |
...
| pricing.fetched_at | 2026-09-03T12:15:41Z |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| S05 | baseline | 1/1 | 6099 | 401 | 0 | 299 | 917 | 5182 | 1 | 1792 | 139554 | 140270 | 0.003615 | 2 | 0 |
...
| wall_ms | 140270 |
| success_rate | 1 |
| cost_per_success | 0.003615 |
| tokens_per_success | 6500.0 |
| resent_share | 0.150353 |
| cache_hit_rate | n/a |
| avg_per_task.tokens | 6500.0 |
| avg_per_task.rounds | 2 |
| avg_per_task.tool_calls | 1 |
| avg_per_task.latency_ms | 139554.0 |
...
- reasoning observed: yes, max reasoning_tokens: 283, max reasoning_chars: 938, Σ reasoning_tokens: 299, reasoning share: 0.7456
- tool-exposed calls: calls: 2, reasoning observed: yes, max reasoning_tokens: 283, max reasoning_chars: 938, Σ reasoning_tokens: 299, reasoning share: 0.7456
...
| scope | baseline |
|---|---|
| median latency_ms per call | 69777.0 |
| median latency_ms (agent) | 69777.0 |
