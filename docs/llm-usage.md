...
| **Σ** (rows 38–43, one `go` run + post-freeze, prompts 44–64) | | claude-sonnet-5 | unknown (row 38) + unknown (row 39) + unknown (row 40) + 231,051 aggregate (row 41) + unknown (row 42) + unknown (row 43) | unknown + unknown + unknown + unknown + unknown + unknown |
