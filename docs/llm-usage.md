...
| **Σ** (rows 38–42, one `go` run, prompts 44–63) | | claude-sonnet-5 | unknown (row 38) + unknown (row 39) + unknown (row 40) + 231,051 aggregate (row 41) + unknown (row 42) | unknown + unknown + unknown + unknown + unknown |
